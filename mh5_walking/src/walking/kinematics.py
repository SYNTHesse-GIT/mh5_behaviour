...
class Chain:
    ...
    def __init__(self, kdl_chain, joint_states,
        ...
        self.joints_states = joint_states
    ...
    @property
    def q(self):
        return [self.joint_states[name] for name in self.names]
...
class Kinematics():
    ...
    def __init__(self,
        ...
        #     }
        self.left_leg = Chain(self.robot.getChain("base_link", "left_landing"))
        self.right_leg = Chain(self.robot.getChain("base_link", "right_landing"))
        self.left_arm = Chain(self.robot.getChain("base_link", "left_hand"))
        self.right_arm = Chain(self.robot.getChain("base_link", "right_hand"))
        self.head = Chain(self.robot.getChain("base_link", "left_camera"))
